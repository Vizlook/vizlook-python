...
from pydantic import conint, ValidationError
...
class Vizlook:
    ...
    def request(
        ...
        *,
        ...
        stream_cls: Type[StreamResponseT] | None = None,
    ) -> NonStreamResponseT | StreamResponseT:
        """
        ...
        try:
            ...
            if stream and stream_cls:
                return cast(StreamResponseT, stream_cls(http_response=response))
    ...
    def search(
        ...
        query: str,
        *,
        max_results: Optional[conint(ge=1, le=20)] = None,
